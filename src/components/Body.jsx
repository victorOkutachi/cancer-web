...
const Body = () => {
  ...
  return (
    ...
    <div className='w-full flex flex-col md:pb-6 px-4 pt-9 md:px-16 overflow-hidden'>
      ...
      <div className='flex flex-col md:flex-row md:justify-between  lg:pb-14 lg:justify-evenly md:items-center'>
      <div className='w-full flex flex-col items-center mx-auto md:flex-row mb-14 md:mb-0' data-aos="fade-up">
