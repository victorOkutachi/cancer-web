...
const Programme = () => {
  ...
  return (
    <div className='w-full flex flex-col font-Merriweather bg-[#c7f9cc] px-4 py-12 md:px-16 ' data-aos="fade-right">
        <h1 className='text-3xl font-bold text-[#008024] pb-4'>Our Programmes</h1>
        <p className='text-[16px] max-w-[600px] pb-4'>
        ...
        <button className='text-[#008024] text-[14px] font-bold rounded-full hover:text-[#008024] border-[2px] border-[#008024] hover:bg-white hover:border-[#008024] py-[6px] w-[160px] flex items-center justify-center md:mx-0'>View Programmes</button>
