    ...
    <div className=' flex flex-col font-Merriweather'>
        ...
        <div className='w-full h-full flex flex-col pt-4 px-4'>
            ...
            <div id='Mentorship Building'>
              ...
              <p className='md:text-[16px]'>Nigeria needs an army of cancer experts in both clinical and basic research capacity if we hope
            ...
            <div id='Diagnosing cancer in nigeria'>
              ...
              <p className='md:text-[16px]'>If diagnosed early, most solid tumors are in fact curable. Early cancer
            ...
            <div id='awareness and cancer prevention'>
              ...
              <p className='md:text-[16px] pb-4'> Cancer prevention is indeed Nigeria's best chance at defeating cancer,
