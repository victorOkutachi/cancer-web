...
const Programs = () => {
  ...
  return (
    <div className='flex flex-col '>
        ...
        <p className='md:text-[16px] text-center px-8 pb-2' >Recognizing the enormity of the challenges our society faces, CCIN is dedicated to making a lasting
       ...
       <div className='flex flex-col mb-4'>
        {programs.map(item=>(
          ...
          <div className='flex flex-col items-center' >
            <p className='md:text-[16px] text-center px-14 py-3'>{item.desc}</p>
            <img className='h-[250px] w-[340px] md:h-[270px] shadow-lg object-fill rounded-md my-3  mx-auto'  src={item.img} key={item.id}/> 
